...
const content = [
  {
    ...
    text: endent`The scientific method has five basic steps, plus one feedback step:
...
6. Iterate: use the results to make new hypotheses or predictions.`,
...

  {
    ...
    text: endent`It generally follows the steps. A scientific investigation is a plan for asking questions and testing possible answers. It generally follows the steps listed ... below 
    1.	Make observations
	2.	Ask a question
